...
int main(int argc, char** argv)
{
	...
	auto fileNameFormat = "C:/Users/Server/source/repos/FB_321/FB_321/data/Emily/%06d.png";
	//auto resultNameFormat = "../result/Emily_4*4_result_%02d.png";
	auto resultNameFormat = "C:/Users/Server/source/repos/FB_321/FB_321/result/Emily_4_4_result_%.png";
	...
	while (true)
	{
		...
		std::string name = resultNameFormat;
		name.replace(name.find("%"), 1, std::to_string(index)); 
