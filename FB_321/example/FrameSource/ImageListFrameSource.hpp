...
inline ImageListFrameSource::ImageListFrameSource(int image_count, std::string file_name_format, int start_index) : imageCount(image_count), startIndex(start_index), fileNameFormat(file_name_format)
{
